...
class LLMCallRepository extends BaseRepository {
    ...
    async findByTraceId(traceId) {
        try {
            ...
            this.logger.error(`Error finding LLM calls by trace ID ${traceId}:`, error);
            throw error;
        }
    }
    ...
    async findBySession(sessionId, options = {}) {
        try {
            ...
            this.logger.error(`Error finding LLM calls by session ${sessionId}:`, error);
            throw error;
        }
    }
    ...
    async findByProvider(providerId, options = {}) {
        try {
            ...
            this.logger.error(`Error finding LLM calls by provider ${providerId}:`, error);
            throw error;
        }
    }
