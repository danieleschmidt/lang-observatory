...
class BaseRepository {
    ...
    async create(data) {
        try {
            ...
            this.logger.debug(`Created ${this.tableName}:`, { id: created[this.primaryKey] });
            return created;
        } catch (error) {
    ...
    async exists(where) {
        try {
            ...
            this.logger.error(`Error checking existence in ${this.tableName}:`, error);
            throw error;
        }
    }
    ...
    async bulkCreate(dataArray) {
        try {
            ...
            return await db.transaction(async (client) => {
                ...
                this.logger.debug(`Bulk created ${results.length} ${this.tableName} records`);
                return results;
            });
        } catch (error) {
    ...
    async bulkUpdate(updates) {
        try {
            ...
            return await db.transaction(async (client) => {
                ...
                this.logger.debug(`Bulk updated ${results.length} ${this.tableName} records`);
                return results;
            });
        } catch (error) {
    ...
    async raw(query, params = []) {
        try {
            ...
            this.logger.error(`Error executing raw query on ${this.tableName}:`, error);
            throw error;
        }
    }
