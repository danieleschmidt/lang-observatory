...
class RouterRegistry {
        ...
        try {
            ...
            this.router.get('/', (req, res) => {
                res.json({
                    ...
                    version: '0.1.0',
                    description: 'A turnkey observability stack for Large Language Model applications',
                    endpoints: {
                    ...
                    documentation: 'https://github.com/terragon-labs/lang-observatory#readme'
                });
            });
    ...
    getRouter() {
        if (!this.initialized) {
            throw new Error('Router registry not initialized. Call initialize() first.');
        }
        return this.router;
    }
}
