...
describe('Security Validation Tests', () => {
    ...
    describe('XSS Protection', () => {
        ...
        test('should sanitize XSS payloads', async () => {
            ...
            const result = await schemaValidator.validate('test-schema', maliciousData, {
                sanitize: true
            });
    ...
    describe('Command Injection Protection', () => {
        test('should detect command injection attempts', async () => {
            ...
            const analysis = await threatDetection.analyzeRequest(cmdInjectionRequest);
            
            expect(analysis.threats.some(t => t.type === 'command_injection')).toBe(true);
    ...
    describe('Rate Limiting', () => {
        test('should detect rate limit violations', async () => {
            ...
            const requests = [];
            for (let i = 0; i < 50; i++) {
                requests.push(threatDetection.analyzeRequest({
                    method: 'GET',
                    url: '/api/data',
    ...
    describe('Authentication Security', () => {
        ...
        test('should reject expired tokens', async () => {
            ...
            const token = await securityManager.generateJWT(payload, { expiresIn: '1ms' });
        ...
        test('should reject tampered tokens', async () => {
            ...
            parts[1] = Buffer.from('{"userId":999,"role":"admin"}').toString('base64');
    ...
    describe('Content Security Policy', () => {
        ...
        test('should validate content against CSP', async () => {
            ...
            const safeResult = await securityManager.validateContentSecurityPolicy(safeContent);
            expect(safeResult.safe).toBe(true);
            
            const unsafeResult = await securityManager.validateContentSecurityPolicy(unsafeContent);
    ...
    describe('Anomaly Detection', () => {
        test('should detect unusual request patterns', async () => {
            ...
            expect(analysis.threats.some(t => 
    ...
    describe('Security Headers', () => {
        test('should generate secure headers', async () => {
            ...
            expect(secureHeaders).toHaveProperty('Referrer-Policy', 'strict-origin-when-cross-origin');
        });
    });
});