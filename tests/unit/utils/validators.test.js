...
describe('Validators', () => {
  describe('validateLLMCallData', () => {
    ...
    it('should require provider and model', () => {
      ...
      expect(() => Validators.validateLLMCallData(invalidData)).toThrow(
        ValidationError
      );
    });
  ...
  describe('validateOperationName', () => {
    ...
    it('should reject empty or null operation names', () => {
      expect(() => Validators.validateOperationName('')).toThrow(
        ValidationError
      );
      expect(() => Validators.validateOperationName(null)).toThrow(
        ValidationError
      );
      expect(() => Validators.validateOperationName(undefined)).toThrow(
        ValidationError
      );
    });
    ...
    it('should reject operation names that are too long', () => {
      ...
      expect(() => Validators.validateOperationName(longName)).toThrow(
        ValidationError
      );
    });
    ...
    it('should reject operation names with invalid characters', () => {
      ...
      invalidNames.forEach(name => {
        expect(() => Validators.validateOperationName(name)).toThrow(
          ValidationError
        );
      });
    });
  ...
  describe('validateMetricData', () => {
    ...
    it('should require name and value', () => {
      ...
      invalidMetrics.forEach(metric => {
        expect(() => Validators.validateMetricData(metric)).toThrow(
          ValidationError
        );
      });
    });
    ...
    it('should validate metric types', () => {
      ...
      expect(() => Validators.validateMetricData(invalidMetric)).toThrow(
        ValidationError
      );
    });
  });
  ...
  describe('validateProvider', () => {
    ...
    it('should reject unknown providers', () => {
      expect(() => Validators.validateProvider('unknown_provider')).toThrow(
        ValidationError
      );
    });
  });
  ...
  describe('validateModel', () => {
    ...
    it('should validate Anthropic models', () => {
      ...
      validModels.forEach(model => {
        expect(() =>
          Validators.validateModel('anthropic', model)
        ).not.toThrow();
      });
    });

    it('should reject invalid model for provider', () => {
      expect(() => Validators.validateModel('openai', 'claude-3')).toThrow(
        ValidationError
      );
      expect(() => Validators.validateModel('anthropic', 'gpt-4')).toThrow(
        ValidationError
      );
    });
    ...
    it('should allow custom providers with any model', () => {
      expect(() =>
        Validators.validateModel('custom', 'any-model-name')
      ).not.toThrow();
    });
  });
  ...
  describe('validateDateRange', () => {
    ...
    it('should reject invalid date formats', () => {
      expect(() =>
        Validators.validateDateRange('invalid-date', '2024-01-02T00:00:00Z')
    ...
    it('should reject end date before start date', () => {
      ...
      expect(() => Validators.validateDateRange(startDate, endDate)).toThrow(
        ValidationError
      );
    });
